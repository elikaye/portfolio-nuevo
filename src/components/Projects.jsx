...
const projects = [
  {
    title: "Tienda Oli — Ecommerce UI",
    image: Ecommerce,
    description:
      "Prototipo de interfaz de e-commerce desarrollado con HTML, CSS y JavaScript. Simula la estructura completa de una tienda online con catálogo de productos.",
    tech: ["HTML", "CSS", "JavaScript"],
    github: "https://github.com/elikaye/tienda-nube",
    demo: "https://tienda-oli.netlify.app",
  },
  {
    title: "Tienda Barbie — Ecommerce Multirubro",
    image: tienda,
    description:
      "E-commerce desarrollado con React, Vite y Tailwind CSS en frontend, y Node.js con Express y MySQL en backend. Incluye autenticación, carrito y cierre de compra por WhatsApp.",
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {/* DESKTOP grid */}
        <div className="hidden md:grid md:grid-cols-2 gap-6 mt-12">
